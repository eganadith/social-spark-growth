...
const content = [
  { heading: "1. Information We Collect", body: "We collect your email address, social media profile links, and payment information necessary to process your orders. We do not collect passwords or login credentials for your social media accounts." },
  ...
  { heading: "3. Data Protection", body: "We implement industry-standard security measures to protect your personal information. All payment data is encrypted and processed through secure payment gateways." },
